...
namespace BalikProjesi.Panels.User
{
    public partial class KontrolKaydiBitir : UserControl
    {
        ...
        private void RaporBtn_Click(object sender, EventArgs e)
        {
            ...
            //popup.label3.Text = HasatDefoBtn.Text + " adet hasat defo elde edildi.";
            //popup.label4.Text = KılcıkBtn.Text + " adet kılçık elde edildi.";
            //popup.label5.Text = BıcakDefoBtn.Text + " adet bıçak defo elde edildi.";
            //popup.label6.Text = DigerBtn.Text + " adet diğer ürün elde edildi.";
            popup.Show();
        }
   
        private void HasatDefoBtn_Click(object sender, EventArgs e)
        {
